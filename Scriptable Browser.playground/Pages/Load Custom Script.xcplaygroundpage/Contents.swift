...
//This page allows you to load a custom user script written directly into this Playground page, for use on the "Browser" page.

//To load a script, type or paste it directly between the two sets of triple quotation marks on this page.  

//If any strings within your script make use of escaped characters, you may want to just go ahead and make sure they're doubly-escaped (use "\\" instead of "\")

//Once your script is entered, tap "Run My Code" to load the script into the playground.
...
PlaygroundKeyValueStore.current["userScript"] = .string(customScript)
